...
/**
 * The unique identifier, comprised of a user’s WeChat ID and App ID, must be filled by developers while sending a
 * request. The purpose is to check whether the user has logged in with another account.
 */
